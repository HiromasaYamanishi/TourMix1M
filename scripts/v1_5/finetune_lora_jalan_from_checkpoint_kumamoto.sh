...
deepspeed --include localhost:0,1,2,3 --master_port 20004 llava/train/train_mem.py\
    ...
    --model_path ./checkpoints/llava-v1.5-13b-jalan-review-lora-v4 \
    --model_base lmsys/vicuna-13b-v1.5 \
    --version v1 \
    --data_path ./playground/data/kumamoto/v1/train.json \
    --image_folder /home/yamanishi/project/trip_recommend/data/jalan_image/kumamoto \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-13b-jalan-review-lora-kumamoto \
    --num_train_epochs 1 \
